...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-around bg-slate-800 text-slate-200 min-h-full ">
      <section className="bg-gradient-to-b from-red-800 to-red-600 w-full flex flex-col items-center justify-around shadow-xl" style={{ minHeight: "min(100vh, 100vw)" }}>
        <div>
          ...
          <div className="px-4 text-xl font-bold text-yellow-500">Send your personal data straight to the CPC!<br />
            No nonsense, no questions asked. </div>
          <div className="text-sm px-4 text-red-400">Launching on 1. Apr. 2024</div>
        </div>
        {!isUploading ? <div className="border-4 border-yellow-500 p-8 rounded-xl drop-shadow-lg hover:drop-shadow-xl
         ...
         min-w-[28rem] text-center h-52"
          ...
          <div className="pb-4">{
            isDragActive ? "Drop your files here, 谢谢！" : "Upload your sensitive personal data here!"
          }</div>
        </div> :
      ...
      <section className="w-full p-12 text-lg">
        <h2 className="text-3xl font-black pb-2">
          Wait, what??
        </h2>
        <p className="pl-2">
          Are you tired of concerns about your private data getting perverted into a game of geopolitics? <br />
          The only winning move is to not play - let go of digital attachments, and live free of fear.
        </p>
        <p className="pl-2 pt-2 text-yellow-100">
          You should still be wary of scammers, hackers, stalkers, and your <i>own</i> government though.
        </p>
      </section>
      <footer></footer>
    </main >
...
const UploadIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32"><path fill="currentColor" d="m16 3.594l-.719.687l-7 7L9.72 12.72L15 7.438V24h2V7.437l5.281 5.282l1.438-1.438l-7-7zM7 26v2h18v-2z" /></svg>